...
const AddSongDialog = () => {
    ...
    const [files, setFiles] = useState<{ audio: null | File; image: File | null }>({
        audio: null,
        image: null
    })
    ...
    const handleSubmit = async () => {
        setIsloading(true)
        try {
            if(!files.audio || !files.image) toast.error("Please upload both audio and image files")
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            <DialogTrigger>
                <Button className="bg-emerald-500 hover:bg-emerald-600 text-black">
                    <Plus className="h-4 w-4 items-center flex" />
                    Add Song
                </Button>
            </DialogTrigger>
                        ...
                        <div className='text-center'>
                            {files.image ? (
                                ...
                                <>
                                    ...
                                    <div className='text-sm mt-1 text-zinc-400 mb-2'>Upload artwork</div>
